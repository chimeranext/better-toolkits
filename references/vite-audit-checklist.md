...
Bundle-health and modernization signals for Vite projects. Codified from the ACME frontend modernization (April 2026), where a legacy multi-library setup was consolidated to Vite with a 55% asset-weight reduction and 93% fewer JS/CSS files.
...
Each signal has: detection command, severity tier, remediation, and the ACME evidence that motivated including it.
...
**ACME evidence:** *"jQuery cargado 2 veces en algunas páginas — Conflictos silenciosos en funcionalidades."*
...
**ACME evidence:** *"Fase 3 — Eliminación de activos legados: borramos 554 archivos obsoletos de public/js y unificamos todo el CSS en Vite."*
...
**ACME evidence:** *"Bootstrap v4 y v5 conviviendo — Conflictos visuales y comportamientos impredecibles."*
...
**ACME evidence:** *"Librerías vendorizadas manualmente — Versiones desactualizadas sin parches de seguridad."* Fase 2A moved jQuery, SweetAlert, and Plyr to npm-managed dependencies.
...
**ACME evidence:** *"Sin sistema de caché confiable — Usuarios recibían versiones mezcladas en despliegues."* After the migration: *"Hash único por versión."*
...
**ACME evidence:** *"SweetAlert v1 (versión 2012) — Librería sin soporte, con vulnerabilidades conocidas."* Replaced by maintained SweetAlert2.
...
**ACME evidence:** Before — *"Auditoría de seguridad: Manual, sin registro."* After — *"npm audit automático en CI/CD."*
...
**ACME evidence:** Before — *"Cambio código → navegador: Minutos (reload completo)."* After — *"Instantáneo (HMR)."*
...
**ACME evidence:** *"Pipeline de pruebas Playwright integrado con Vite permite detectar regresiones visuales automáticamente antes de cada despliegue."*
