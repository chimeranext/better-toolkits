...
| [`/make-no-mistakes:ready-to-review-mergeable`](commands/ready-to-review-mergeable.md) | Leave the current branch PR-ready and mergeable — default Diátaxis `status: review`, fix CI, push; **never merge** |
