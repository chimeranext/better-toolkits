...
- [ ] Pedir a Juan Carlos aprobacion para crear labels `moscow/must|should|could|wont` en Linear workspace ChimeraNext (mensaje en Slack #C08FZTCT1BN, combinable con el tracking del spec). Cuando apruebe, v1.1 flip `--target=labels` a funcional.
