<!--
  Vendored from https://github.com/jam01/SRS-Template/blob/master/srs-template-bare.md
  License: CC0 1.0 Universal (Public Domain Dedication) — see upstream LICENSE.
  Adapted: added RFC 2119 keywords note + per-requirement ID hint + traceability hint.
  Structure inherits ISO/IEEE 830:1998; content guidance follows ISO/IEC/IEEE 29148:2018.
-->
...
> **Keywords (RFC 2119):** SHALL / SHALL NOT / SHOULD / MAY. Every requirement is
> atomic, unique (ID), verifiable, and implementation-free (§3.2 functional only).
...
### 3.2 Functions
<!-- externally observable behaviors organized by feature/use case. Express each as:
     FR-001 | The system SHALL <observable behavior>. Acceptance: <testable criterion>. -->
